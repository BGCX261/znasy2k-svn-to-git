...
public class Shouru_Sreach extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.getResources().getConfiguration().orientation == 
        	...
        	//竖屏 
        	setContentView(R.layout.shouru_sreach);
		} else { 
		    //横屏时 
			setContentView(R.layout.shouru_sreach_h);
		} 
        ...
        initTime();
        setDatetime();
        setTitle(this.getResources().getString(R.string.app_name) + "-" + this.getResources().getString(R.string.cxsrjl)); 
 
        sreachSpinner =(Spinner) findViewById(R.id.shouruSpinner); 
        Cursor cursor = managedQuery(Sjjzb.SjjzbColumns.CONTENT_URI_LEIXIN, leibieCursorColumns, Sjjzb.SjjzbColumns.LEIBIE + " = 2 or " + Sjjzb.SjjzbColumns.LEIBIE + " = 4", null,
        ...
        fhimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	startActivity(new Intent(Shouru_Sreach.this, znasy2k.gmail.com.c.Shouru.class));
            }
         });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_SREACH:{
        	...
        	mIntent.setClass(Shouru_Sreach.this, znasy2k.gmail.com.c.Shouru_sreachList.class);   
