...
public class Shouru_sreachList extends Activity {
    ...
    String ssqlwhere1 = "";
    String ssqlwhere2 = "";
    private TextView shourusreachxq;
    private Bundle bl;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.getResources().getConfiguration().orientation == 
        	...
        	//竖屏 
        	setContentView(R.layout.shourusreachlist); 
		} else { 
		    //横屏时 
			setContentView(R.layout.shourusreachlist_h); 
		} 
        setTitle(this.getResources().getString(R.string.app_name) + "-" + this.getResources().getString(R.string.cxsrjljg));        
        ...
        shourusreachxq = (TextView) findViewById(R.id.shourusreachxq);
        ...
        String szchj = this.getResources().getString(R.string.shouruhjmh) + " " ;
        sxqtext = sxqtext + srqtext;
        if(bsrjezj == BigDecimal.ZERO){
        	szchj = szchj + "0 " +  this.getResources().getString(R.string.yuan);
	    } else {
	    	szchj = szchj + bsrjezj.toString() +  this.getResources().getString(R.string.yuan);
	    }
        ...
        shourusreachxq.setText(sxqtext);
        ...
        fhimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	startActivity(new Intent(Shouru_sreachList.this, znasy2k.gmail.com.c.Shouru.class));
            }
         });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_BACK: {
			startActivity(new Intent(Shouru_sreachList.this, znasy2k.gmail.com.c.Shouru_Sreach.class));
            return true;
        }
        ...
        case MENU_ITEM_EDIT:{
            ...
            intent.setClass(Shouru_sreachList.this, znasy2k.gmail.com.c.Shouru_Edit.class);   
