...
public class ZcLeiB_Edit extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(this.getResources().getString(R.string.app_name) + "-" + this.getResources().getString(R.string.xgzcleib)); 
		...
		Log.d("ssqlwhere", "ssqlwhere:" + ssqlwhere);
        ...
        bcimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	...
            	if(mingcheng.equals("")) {
            		new AlertDialog.Builder(ZcLeiB_Edit.this) 
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        private void backSrLeiBActivity() {
        	startActivity(new Intent(ZcLeiB_Edit.this, znasy2k.gmail.com.c.ZcLeiB.class));
        }
}