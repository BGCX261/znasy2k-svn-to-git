...
public class SrLeiB_Create extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bcimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	...
            	if(mingcheng.equals("")) {
            		new AlertDialog.Builder(SrLeiB_Create.this) 
    ...
    private void backSrLeiBActivity() {
    	startActivity(new Intent(SrLeiB_Create.this, znasy2k.gmail.com.c.SrLeiB.class));
    }
}