...
public class Mxcx extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initTime();
        setDatetime();
        setTitle(this.getResources().getString(R.string.app_name) + "-" + this.getResources().getString(R.string.mxcx)); 
 
        sreachSpinner =(Spinner) findViewById(R.id.zhichuSpinner); 
        Cursor cursor = managedQuery(Sjjzb.SjjzbColumns.CONTENT_URI_LEIXIN, leibieCursorColumns, null, null,
        ...
        fhimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	startActivity(new Intent(Mxcx.this, znasy2k.gmail.com.c.GridAnimation.class));
            }
         });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_SREACH:{
            ...
            intent.setClass(Mxcx.this, znasy2k.gmail.com.c.Mxcx_xq.class);          
