...
public class SrLeiB extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(this.getResources().getString(R.string.app_name) + "-" + this.getResources().getString(R.string.srleiblb));        
    	...
    	ssqlwhere = Constant.LEIXIN + "." + Sjjzb.SjjzbColumns.LEIBIE + " = 2";
        ...
        fhimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	startActivity(new Intent(SrLeiB.this, znasy2k.gmail.com.c.Xtsz.class));
            }
         });
        ...
        xjimgbt.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
            	startActivity(new Intent(SrLeiB.this, znasy2k.gmail.com.c.SrLeiB_Create.class));
            }
         });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_DELETE:{
            ...
            Cursor cursorzc = managedQuery(Sjjzb.SjjzbColumns.CONTENT_URI_SHOUZHI, ShouruCursorColumns, szsqlwhere, null,
            		Constant.SHOUZHI + "." + Sjjzb.SjjzbColumns.DEFAULT_ID_SORT_ORDER);
            if(cursorzc.moveToNext()){
            	new AlertDialog.Builder(SrLeiB.this) 
        ...
        case MENU_ITEM_EDIT:{
            ...
            intent.setClass(SrLeiB.this, znasy2k.gmail.com.c.SrLeiB_Edit.class);   
